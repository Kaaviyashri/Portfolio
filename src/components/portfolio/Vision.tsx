...
export function Vision() {
  return (
    <section id="vision" className="relative overflow-hidden px-6 py-32 lg:pl-72">
      ...
      <svg className="pointer-events-none absolute bottom-0 left-0 right-0 -z-0 h-64 w-full opacity-40" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <defs>
        ...
        <path fill="url(#mg)" d="M0,200 L160,90 L320,170 L480,60 L640,150 L800,80 L960,180 L1120,100 L1280,170 L1440,120 L1440,320 L0,320 Z" />
      </svg>

      <div className="relative mx-auto max-w-5xl">
        <SectionLabel numeral="VII" label="Vision" />
        ...
        >
          ...
          <figcaption className="mt-4 text-sm text-[var(--gold)]">— Kaaviyashri Saraboji</figcaption>
        </motion.figure>
      </div>
    </section>
  );
