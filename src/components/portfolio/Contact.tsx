      ...
      <div className="relative z-10 px-6 py-32 lg:pl-72">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-[1fr_1fr]">
            <div>
              <SectionLabel numeral="IX" label="Let's Connect" />
              ...
              <p className="mt-6 max-w-md text-sm leading-relaxed text-muted-foreground">
                Open to AI engineering opportunities, research collaborations,
                healthcare AI innovation, and conversations about building
              ...
              <div className="mt-10 space-y-3 text-sm">
                <ContactRow
                  icon={Mail}
                  label="kaaviyasaraboji@gmail.com"
                  href="mailto:kaaviyasaraboji@gmail.com"
                />
                <ContactRow
                  icon={Linkedin}
                  label="linkedin.com/in/kaaviyashri"
            ...
            <div className="relative hidden lg:block">
              ...
              >
                &ldquo;Trust yourself, work hard, and never lose hope; what seems
                impossible today may become your reality tomorrow.&rdquo;
